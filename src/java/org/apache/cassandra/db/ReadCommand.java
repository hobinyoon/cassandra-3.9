...
public abstract class ReadCommand extends MonitorableImpl implements ReadQuery
{
    ...
    public UnfilteredPartitionIterator executeLocally(ReadExecutionController executionController)
    {
        ...
        //logger.warn("Mutant: ksName={} cfName={} mutantTable={}"
        //        , cfs.metadata.ksName, cfs.metadata.cfName, cfs.metadata.mutantTable);
        // [ReadStage-2] ReadCommand.java:398 Mutant: ksName=ycsb cfName=usertable mutantTable=true
