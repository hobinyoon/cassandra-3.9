...
public class MemSsTableAccessMon
{
    ...
    public static void Deleted(Descriptor d) {
        ...
        _updatedSinceLastOutput = true;
        logger.warn("Mutants: SstDeleted {}", d);
        _or.Wakeup();
    }

    private static class OutputRunnable implements Runnable {
        static final long reportIntervalMs =
            DatabaseDescriptor.getMutantsOptions().tablet_access_stat_report_interval_in_ms;
        ...
        public void run() {
            ...
            while (true) {
                ...
                logger.warn("Mutants: TabletAccessStat {}", sb.toString());
            }
        }
    }
}
